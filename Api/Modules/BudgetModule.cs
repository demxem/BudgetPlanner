...
public static class BudgetModule
{
    ...
    private static async Task<IResult> InsertBudget(BudgetModel budget, IBudget data)
    {
        try
        {
    ...
    private static async Task<IResult> UpdateBudget(BudgetModel budget, IBudget data)
    {
        try
        {
    ...
    private static async Task<IResult> DeleteBudget(IBudget data, int id)
    {
        try
        {
